...
const Notification = props => {
    const { signupEmail, signupPassword, isSignedin } = props;
    ...
    return (
     <View>
            ...
            <TouchableOpacity  onPress={handleSignup}><Text>Notification on</Text></TouchableOpacity>
            <TouchableOpacity  onPress={handleSignup}><Text>Maybe later</Text></TouchableOpacity>
     </View>
 );
}
